...
def load_train_sparse(root_dir: str = "./data"):
...
def load_train_csv(root_dir: str = "./data") -> Dict[str, List]:
...
def load_valid_csv(root_dir: str = "./data") -> Dict[str, List]:
...
def load_public_test_csv(root_dir: str = "./data") -> Dict[str, List]:
...
def load_private_test_csv(root_dir: str = "./data") -> Dict[str, List]:
...
def save_private_test_csv(data: Dict[str, List], file_name: str = "private_test_result.csv") -> None:
...
def evaluate(data: Dict[str, List], predictions: List, threshold: float = 0.5) -> float:
...
def sparse_matrix_evaluate(data: Dict[str, List], matrix: Any, threshold: float = 0.5) -> float:
...
def sparse_matrix_predictions(data: Dict[str, List], matrix: Any, threshold: float = 0.5) -> List:
